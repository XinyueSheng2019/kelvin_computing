...
class TransientClassifier(tf.keras.Model):
    ...
    def __init__(self, label_dict, N_image, dimension, meta_dimension = 11, ks = 16, pooling_size = 2, neurons = [[128,2],[128,2],[128,2]], res_cnn_group = None, Resnet_op = False, **kwargs):
        ...
        self.dense_1 = layers.Dense(64, kernel_initializer = 'uniform', activation='relu', name = 'dense_im1')
        ...
        self.dense_m1 = layers.Dense(units = 128, kernel_initializer = 'uniform', activation = 'relu', name = 'dense_me1', input_dim = self.meta_dimension)
        self.dense_m2 = layers.Dense(units = 128, kernel_initializer = 'uniform', activation = 'relu', name = 'dense_me2')

        ### combine two sub-models
        self.concatenate = layers.Concatenate(axis = -1, name = 'concatenate')
        self.dense_c1 = layers.Dense(64, kernel_initializer = 'uniform', activation = 'relu', name = 'dense_c1')
        self.dense_c2 = layers.Dense(64, kernel_initializer = 'uniform', activation = 'relu', name = 'dense_c2')
        self.dense_2 = layers.Dense(len(self.label_dict), kernel_initializer = 'uniform', activation='softmax' , name = 'output')

    def call(self, inputs):
        # initialize_nn_seed(0) 
